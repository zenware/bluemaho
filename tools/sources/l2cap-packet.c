...
void usage(void)
{
	printf("l2cap-packet -a <bdaddr> -c <l2cap_code> -i <l2cap_ident> -p <payload> -s <l2cap_headersize>\n");
        ...
        printf("L2CAP_COMMAND_REJ 1\n");
        printf("L2CAP_CONN_REQ    2\n");
        printf("L2CAP_CONN_RSP    3\n");
        printf("L2CAP_CONF_REQ    4\n");
        printf("L2CAP_CONF_RSP    5\n");
        printf("L2CAP_DISCONN_REQ 6\n");
        printf("L2CAP_DISCONN_RSP 7\n");
        printf("L2CAP_ECHO_REQ    8\n");
        printf("L2CAP_ECHO_RSP    9\n");
        printf("L2CAP_INFO_REQ    10\n");
        printf("L2CAP_INFO_RSP    11\n");
        exit(EXIT_SUCCESS);
}
